# -*- coding: utf-8 -*-
# Generated by Django 1.9.8 on 2017-07-14 07:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('gender', models.CharField(choices=[(b'male', '\u7537'), (b'female', '\u5973')], max_length=8)),
                ('address', models.CharField(blank=True, max_length=64, null=True)),
                ('mobile', models.CharField(blank=True, max_length=11, null=True)),
                ('image', models.ImageField(default=b'avator/default.png', max_length=64, upload_to=b'avator/%Y/%m')),
