...
class HomeView(View):
    def get(self, request):
        article_list = Article.objects.exclude(is_aboutme = True).order_by('-create_time')
...
class ArchivesView(View):
    def get(self, request, year, month):
        ...
        article_list = Article.objects.exclude(is_aboutme = True).filter(create_time__year=year, create_time__month=month).order_by('-create_time')
